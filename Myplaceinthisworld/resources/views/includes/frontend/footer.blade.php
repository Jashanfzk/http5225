<footer id="footer" class="footer position-relative dark-background pt-2">
  ...
  <div class="footer-texture mt-2">
    <div class="textured-img" style="background-image: url('{{ asset('assets/img/textured-footer.svg') }}');"></div>
  </div>
    <div class="container footer-top">
      <div class="row gy-4 align-items-center">
        ...
        <div class="col-lg-2 col-md-12 footer-links">
          ...
          <a href="{{ route('support') }}" class="btn btn-cta btn-danger mt-3">Contact Us</a>
        </div>
