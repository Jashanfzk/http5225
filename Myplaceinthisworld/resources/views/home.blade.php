          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div class="feature-card align-items-center">
                ...
                <img src="{{ asset('assets/img/CBC-logo.png') }}" class="img-fluid">
                </a>
              </div>
            </div>
            <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div class="feature-card align-items-center">
                ...
                <img src="{{ asset('assets/img/CTV-logo.png') }}" class="img-fluid">
                </a>
              </div>
            </div>
            <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div class="feature-card align-items-center">
                ...
                <img src="{{ asset('assets/img/ontario-logo.png') }}" class="img-fluid">
                </a>
              </div>
            </div>
            <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div class="feature-card align-items-center">
                ...
                <img src="{{ asset('assets/img/conestoga-logo.svg') }}" class="img-fluid">
                </a>
              </div>
            </div>
          </div>
        ...
        <div class="row align-items-center g-5 mb-5">
          <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
            <div class="hero-image-wrapper">
              <img src="{{ asset('assets/img/kids-studying.png') }}" alt="Student Life" class="img-fluid main-image">
                  ...
                  <div class="highlights-gallery">
                    <div class="gallery-grid">
                      <div class="gallery-item large" data-aos="zoom-in" data-aos-delay="800">
                        <img src="{{ asset('assets/img/education/campus-3.webp') }}" alt="Campus Life" class="img-fluid" loading="lazy">
                        <div class="gallery-overlay">
                          <h5>Modern Campus</h5>
                        </div>
                      </div>
                      <div class="gallery-item small" data-aos="zoom-in" data-aos-delay="900">
                        <img src="{{ asset('assets/img/education/students-5.webp') }}" alt="Students" class="img-fluid" loading="lazy">
                        <div class="gallery-overlay">
                          <h6>Student Life</h6>
                        </div>
                      </div>
                      <div class="gallery-item small" data-aos="zoom-in" data-aos-delay="1000">
                        <img src="{{ asset('assets/img/education/teacher-7.webp') }}" alt="Faculty" class="img-fluid" loading="lazy">
                        <div class="gallery-overlay">
